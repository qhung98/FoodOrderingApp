...
public class HistoryAdapter extends FirebaseRecyclerAdapter<Order, HistoryAdapter.ViewHolder> {
    ...
    public HistoryAdapter(@NonNull FirebaseRecyclerOptions<Order> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Order model) {
//        holder.tvIdOrder.setText(model.getId());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView tvIdOrder, tvHistoryUserName, tvHistoryPhone, tvHistoryAddress, tvHistoryTime, tvHistorySum;
